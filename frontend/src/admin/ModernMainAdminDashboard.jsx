  ...
  const PlaceholderPage = ({ title, icon, description }) => (
    <div className="flex items-center justify-center min-h-[600px]">
      <div className="text-center p-12 bg-white rounded-2xl shadow-lg max-w-2xl mx-auto">
        <div className="w-20 h-20 mx-auto mb-6 bg-gradient-to-r from-blue-500 to-purple-500 rounded-2xl flex items-center justify-center text-4xl shadow-lg">
          {icon}
        </div>
            ...
            <div className="flex justify-between items-center">
              <div>
                <div className="flex items-center space-x-3">
                  <div className="w-1 h-8 bg-gradient-to-t from-blue-600 to-purple-500 rounded-full"></div>
                  <div>
              ...
              <div className="flex items-center space-x-3">
                {/* Notification */}
                <button className="relative p-3 bg-gray-100 rounded-lg hover:bg-gray-200 transition-colors">
                ...
                <div className="relative group">
                  <button className="flex items-center space-x-3 p-3 bg-gray-100 rounded-lg hover:bg-gray-200 transition-colors">
                  ...
                  {/* Dropdown menu */}
                  <div className="absolute right-0 top-full mt-2 w-48 bg-white rounded-lg shadow-xl border border-gray-200 opacity-0 group-hover:opacity-100 invisible group-hover:visible transition-all duration-200 z-50">
                    <div className="p-2">
                      <a href="/dashboard" className="flex items-center px-4 py-3 text-sm text-blue-600 hover:bg-blue-50 rounded-lg transition-colors font-medium">
                      ...
                      <a href="#" className="flex items-center px-4 py-3 text-sm text-gray-700 hover:bg-gray-100 rounded-lg transition-colors">
                        <svg className="w-4 h-4 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
