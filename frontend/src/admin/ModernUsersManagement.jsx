    ...
    return (
      <div className="flex items-center justify-center h-screen">
        <div className="relative">
          ...
          <div className="absolute inset-0 w-20 h-20 border-4 border-blue-200 rounded-full border-t-blue-600"></div>
        </div>
      </div>
    );
  }
    ...
    <div className="space-y-8 p-6">
        ...
        <div className="flex flex-col lg:flex-row gap-6">
          ...
          <div className="flex-1 relative">
            ...
            <input
              ...
              className="w-full pl-12 pr-4 py-3 bg-white border border-white/30 rounded-2xl focus:outline-none focus:ring-2 focus:ring-purple-500 focus:border-transparent backdrop-blur-none transition-colors duration-150"
            />
          </div>
          ...
          <div className="relative">
            <select
              ...
              className="appearance-none bg-white border border-white/30 rounded-2xl px-6 py-3 pr-10 focus:outline-none focus:ring-2 focus:ring-purple-500 backdrop-blur-none transition-colors duration-150"
            >
          ...
          <button
            ...
            disabled={loading}
            className="bg-gradient-to-r from-purple-500 to-pink-500 hover:from-purple-600 hover:to-pink-600 text-white px-8 py-3 rounded-2xl transition-colors duration-150  shadow-lg hover:shadow-xl flex items-center disabled:opacity-50 disabled:cursor-not-allowed"
          >
            {loading ? (
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        {filteredUsers.map((user, index) => (
          ...
          >
            {/* Effet de brillance */}
            <div className="absolute inset-0 bg-gradient-to-r from-transparent via-white/10 to-transparent -translate-x-full hover:translate-x-full transition- duration-150"></div>
            
            {/* Avatar et infos principales */}
            <div className="flex items-center mb-4">
              <div className="w-16 h-16 bg-gradient-to-r from-purple-400 to-pink-400 rounded-2xl flex items-center justify-center mr-4 shadow-lg  transition- duration-150">
      ...
      {showModal && (
        <div className="fixed inset-0 bg-black/50 backdrop-blur-none flex items-center justify-center z-50 p-4">
          <div className="bg-white/90 backdrop-blur-none rounded-3xl p-8 w-full max-w-md mx-4 shadow-2xl border border-white/20 transition-colors duration-150 scale-100">
            {/* Header du modal */}
            ...
            <div className="space-y-6">
              <div>
                ...
                <input
                  ...
                  className="w-full px-4 py-3 bg-white border border-gray-300 rounded-2xl focus:outline-none focus:ring-2 focus:ring-purple-500 transition-colors duration-150"
              ...
              <div className="flex justify-end space-x-4 pt-6">
                ...
                <button
                  ...
                  className="px-6 py-3 bg-gradient-to-r from-purple-500 to-pink-500 text-white rounded-2xl hover:from-purple-600 hover:to-pink-600 transition-colors duration-150 shadow-lg hover:shadow-xl  disabled:opacity-50 disabled:cursor-not-allowed flex items-center"
                >
                  {submitting ? (
                    <>
